...
function scene:create( event )
    ...
    bkg_image = display.newImageRect("Images2/instructionScreen1.png", display.contentWidth, display.contentHeight)
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        --This is where the audio begins to play
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then
        ...
        --After you leave the scene, the sound stops playing
