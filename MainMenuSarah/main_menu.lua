...
function scene:create( event )
    ...
    bkg_image = display.newImage("Images2/mainScreenPhoto.png")
...
function scene:show( event )
   ...
   elseif ( phase == "did" ) then       
     -- start the main screen bkgMusic
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then
        ...
        --Stops the music after leaving the scene
    ...
    elseif ( phase == "did" ) then
        ...
        --stops the background music for this screen
